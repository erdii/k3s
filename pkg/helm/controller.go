...
import (
	...
	batchclient "github.com/erdii/k3s/types/apis/batch/v1"
	coreclient "github.com/erdii/k3s/types/apis/core/v1"
	k3s "github.com/erdii/k3s/types/apis/k3s.cattle.io/v1"
	rbacclients "github.com/erdii/k3s/types/apis/rbac.authorization.k8s.io/v1"
