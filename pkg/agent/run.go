...
import (
	...
	"github.com/erdii/k3s/pkg/agent/config"
	"github.com/erdii/k3s/pkg/agent/containerd"
	"github.com/erdii/k3s/pkg/agent/flannel"
	"github.com/erdii/k3s/pkg/agent/proxy"
	"github.com/erdii/k3s/pkg/agent/syssetup"
	"github.com/erdii/k3s/pkg/agent/tunnel"
	"github.com/erdii/k3s/pkg/cli/cmds"
	"github.com/erdii/k3s/pkg/daemons/agent"
